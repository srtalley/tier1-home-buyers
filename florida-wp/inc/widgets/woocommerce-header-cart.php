...
class Woocommerce_Header_Cart extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Woocommerce Header Cart', 'WEBNUS_TEXT_DOMAIN' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="woo-cart-header">
				...
				?>
					<ul class="<?php echo implode(' ', $list_class); ?>">
						...
						<?php else : ?>
							...
							<li><?php _e( 'No products in the cart.', 'WEBNUS_TEXT_DOMAIN' ); ?></li>
			...
			<?php endif; ?>
                ...
                <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="qbutton white view-cart"><?php _e( 'Cart', 'WEBNUS_TEXT_DOMAIN' ); ?> </a>

                    <span class="total"><?php _e( 'Total', 'WEBNUS_TEXT_DOMAIN' ); ?>:<span><?php echo $woocommerce->cart->get_cart_subtotal(); ?></span></span>

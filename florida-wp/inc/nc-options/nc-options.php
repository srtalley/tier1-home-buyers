...
function setup_framework_options() {
    ...
    $sections[] = array(
		...
		array(
                ...
                'options' => array('' => 'Default','perdido' => 'Perdido', 'wekiva' => 'Wekiva', 'manatee' => 'Manatee', 'alafia' => 'Alafia'),
			),
    ...
    $sections[] = array(
        ...
        'fields' => array(
            ...
            array(
				...
				'desc' => __('<p class="description">Copy "Typekit Kid ID" from <a href="https://typekit.com/fonts" target="_blank">here</a>.</p>', WEBNUS_TEXT_DOMAIN),
            ),
            array(
    ...
    $sections[] = array(
        ...
        array(
			...
			array(
                ...
                'type'=>'color',
                'title'=>'Scroll to top background color ','WEBNUS_TEXT_DOMAIN',  
            ),
    ...
    $sections[] = array(
        ...
        'fields' => array(
             ...
             array(
                ...
                'options' => array('1' => __('Blog 1(Full Width Image)', WEBNUS_TEXT_DOMAIN), '2' => __('Blog 2(Thumbnail Image)', WEBNUS_TEXT_DOMAIN)),
                'std' => '1'
            ),
			 array(
